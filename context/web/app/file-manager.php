...
$auth_users = array($_SERVER['TL_FILES_ADMIN'] => $_SERVER['TL_FILES_ADMIN_PSWD']);
...
$root_path = $_SERVER['TL_FILES_DIR'];

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = $_SERVER['TL_FILES_PATH'];
...
$upload_extensions = 'gif,png,bmp,jpg,jpeg'; // 'gif,png,jpg'
...
if ($use_auth) {
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        // Logging In
        sleep(1);
        if (isset($auth_users[$_POST['fm_usr']]) && md5($_POST['fm_pwd']) === md5($auth_users[$_POST['fm_usr']])) {
        ...
        <div class="path login-form">
            <img src="/gui/themes/default/images/tl-logo-transparent-12.5.png" style="margin: 5px 0;">
            <h3 style="margin: 5px 0;">Repositório de imagens - Testlink</h3>
            <form action="" method="post">
                <label for="fm_usr">Username</label>
                <input type="text" id="fm_usr" name="fm_usr" value="" placeholder="Username" required><br>
                <label for="fm_pwd">Password</label>
                <input type="password" id="fm_pwd" name="fm_pwd" value="" placeholder="Password" required><br>
...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    <script type="text/javascript">
      Dropzone.options.fileuploader = { acceptedFiles: 'image/*' };
    </script>
    <div class="path">
        ...
        <p>
            ...
            if ($send_mail && !FM_READONLY) {
                ...
                <b><a href="javascript:mailto('<?php echo urlencode(trim(FM_ROOT_PATH . '/' . FM_PATH)) ?>','<?php echo urlencode($file) ?>')"><i
                                class="fa fa-pencil-square"></i> Mail</a></b> &nbsp;
            <?php } ?>
...
?>
    <form action="" method="post">
        ...
        <table class="table" id="main-table">
            ...
            <tr>
                <?php if (!FM_READONLY): ?>
                    <th style="width:3%"><label><input type="checkbox" title="Invert selection"
        ...
        <?php if (!FM_READONLY): ?>
            <p class="path footer-links"><a href="#/select-all" class="group-btn"
                ...
                <a href="#/unselect-all" class="group-btn" onclick="unselect_all();return false;"><i
                            class="fa fa-window-close"></i> Unselect all</a> &nbsp;
                <a href="#/invert-all" class="group-btn" onclick="invert_all();return false;"><i
                            class="fa fa-th-list"></i> Invert selection</a> &nbsp;
                ...
                <a href="javascript:document.getElementById('a-zip').click();" class="group-btn"><i
                            class="fa fa-file-archive-o"></i> Zip </a> &nbsp;
                ...
                <a href="javascript:document.getElementById('a-copy').click();" class="group-btn"><i
                            class="fa fa-files-o"></i> Copy </a>
                <a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="float-right"
                   style="color:silver">H3K | Tiny File Manager</a></p>
        <?php endif; ?>
    </form>
...
function fm_show_nav_path($path) {
    ...
    <div class="path main-nav">
        ...
        <div class="float-right">
            ...
            <?php endif; ?>
            <?php if (FM_USE_AUTH): ?><a title="Logout" href="?logout=1"><i class="fa fa-sign-out"
        ...
        <div id="createNewItem" class="modalDialog">
            <div class="model-wrapper"><a href="#close" title="Close" class="close">X</a>
                ...
                <p>
                    ...
                    <input type="submit" name="submit" class="group-btn" value="Create Now"
                           onclick="newfolder('<?php echo fm_enc(FM_PATH) ?>');return false;"></p></div>
        </div>
